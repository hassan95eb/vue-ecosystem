...
| --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Logic / composables only, **no `.vue` files** — `core`, `realtime`, `state-machine`, `query-builder` (engine), `virtual-scroll` (composable)                                                                                | **tsup** (esbuild)                                               | Faster, far lighter config, and emits ESM + CJS + `.d.ts` for multiple entry points without a bespoke rollup setup per entry                                |
