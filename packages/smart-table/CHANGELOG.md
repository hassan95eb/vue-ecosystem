...
- ec4b721: MVP: a headless data table built on `virtual-scroll` and `query-builder`.
...
- Updated dependencies [61e8724]
  - @vue-ecosystem/query-builder@0.2.0

## 0.1.1

### Patch Changes

- Updated dependencies [36d7164]
  - @vue-ecosystem/virtual-scroll@0.2.0
